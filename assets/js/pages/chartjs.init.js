  ...
  ChartJs.prototype.init = function () {
    ...
    var lineChart = {
      ...
      datasets: [{
        ...
        pointBorderColor: "#5b8ce8",
        pointBackgroundColor: "#fff",
        pointBorderWidth: 1,
        pointHoverRadius: 5,
        pointHoverBackgroundColor: "#5b8ce8",
    ...
    var donutChart = {
      ...
      datasets: [{
        data: [300, 210],
        backgroundColor: ["#5b8ce8", "#ebeff2"],
        hoverBackgroundColor: ["#5b8ce8", "#ebeff2"],
    ...
    var radarChart = {
      ...
      datasets: [{
        ...
        backgroundColor: "rgba(91, 140, 232, 0.2)",
        borderColor: "#5b8ce8",
        pointBackgroundColor: "#5b8ce8",
        pointBorderColor: "#fff",
        pointHoverBackgroundColor: "#fff",
        pointHoverBorderColor: "#5b8ce8",
    ...
    var polarChart = {
      datasets: [{
        data: [11, 16, 7, 18],
        backgroundColor: ["#50a5f1", "#34c38f", "#f1b44c", "#5b8ce8"],
        label: 'My dataset',
        // for legend
        hoverBorderColor: "#fff"
      }],
...
module.exports = __webpack_require__(/*! F:\wamp\www\themesbrand\Backend\Minible\Laravel\dev\resources\js\pages\chartjs.init.js */"./resources/js/pages/chartjs.init.js");
