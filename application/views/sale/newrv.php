<div class="row">
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                <center><h4 class="card-title"><?=  $this->lang->line('create_recipt_voucher') ?></h4></center>
                <?php echo form_open('sale/newrv', array('id' => 'rv-form')) ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label"><?=  $this->lang->line('customer_received_from') ?><span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select required name="invoice_id" class="form-control select2" id="receipt_against_invoice">
                                <option value="">--<?=  $this->lang->line('selectin') ?>--</option>
                                <?php foreach ($sis as $c) { ?>
